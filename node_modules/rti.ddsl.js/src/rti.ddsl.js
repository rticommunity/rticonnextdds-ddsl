...
exports.RTIDDSL = function(useConsole, L) {
    ...
    this.getArrayCount = function(nodeKey) {
        //return parseInt(this.executeLua("return #__rtiLookupTree['" + nodeKey + "']")[0]);
        /*
        _theLuaVM.getglobal("lua_getArrayCount");
        ...
        return retVal;
        */
        return callLuaFunction1("lua_getArrayCount", nodeKey);
    }
    // }}}
    // {{{ getArrayItem
    // ----------------------------------------------------------------------------
    this.getArrayItem = function(nodeKey, idx) {
        // return this.executeLua("return __rtiLookupTree.addNode(__rtiLookupTree['" + nodeKey + "'][" + idx + "])")[0];
        /*
        _theLuaVM.getglobal("lua_getArrayItem");
        _theLuaVM.push(nodeKey);
        _theLuaVM.push(idx);
        _theLuaVM.pcall(2, 1);
        var retVal = _theLuaVM.lua_to_js(1);
        ...
        return retVal;
        */
        return callLuaFunction1("lua_getArrayItem", nodeKey, idx);
    }
    // }}}
    // {{{ getKind
    // ----------------------------------------------------------------------------
    ...
    this.getKind = function(nodeKey) {
        // return this.executeLua("return __rtiLookupTree['" + nodeKey + "'][xtypes.KIND]()")[0];
        /*
        _theLuaVM.getglobal("lua_getKind");
        _theLuaVM.push(nodeKey);
        _theLuaVM.pcall(1, 1);
        var retVal = _theLuaVM.lua_to_js(1);
        _theLuaVM.pop(1);
        return retVal;
        */
        return callLuaFunction1("lua_getKind", nodeKey);
    }
    // }}}
    // {{{ getName
    // ----------------------------------------------------------------------------
    this.getName = function(nodeKey) {
        //return this.executeLua("return __rtiLookupTree['" + nodeKey + "'][xtypes.NAME]")[0];
        return callLuaFunction1("lua_getName", nodeKey);
    }
    // }}}
    // {{{ toString
    // ----------------------------------------------------------------------------
    this.toString = function(nodeKey) {
        // return this.executeLua("return tostring(__rtiLookupTree['" + nodeKey + "'])")[0];
        return callLuaFunction1("lua_toString", nodeKey);
    }
    // }}}
    // {{{ getEnclosingScope
    // ----------------------------------------------------------------------------
    this.getEnclosingScope = function(nodeKey) {
        // return this.executeLua("return __rtiLookupTree['" + nodeKey + "'][xtypes.NS]")[0];
        return callLuaFunction1("lua_getEnclosingScope", nodeKey);
    }
    // }}}
    // {{{ getSwitch
    // ----------------------------------------------------------------------------
    this.getSwitch = function(nodeKey) {
        // return this.executeLua("return __rtiLookupTree.addNode(__rtiLookupTree['" + nodeKey + "'][xtypes.SWITCH])")[0];
        return callLuaFunction1("lua_getSwitch", nodeKey);
    }
    // }}}
    // {{{ getBase
    // ----------------------------------------------------------------------------
    ...
    this.getBase = function(nodeKey) {
        // return this.executeLua("return __rtiLookupTree.addNode(__rtiLookupTree['" + nodeKey + "'][xtypes.BASE])")[0];
        return callLuaFunction1("lua_getBase", nodeKey);
    }
    // }}}
    ...
    this.getNsName = function(nodeKey) {
        //return this.executeLua("return xtypes.nsname(__rtiLookupTree['" + nodeKey + "'])")[0];
        return callLuaFunction1("lua_getNsName", nodeKey);
    }
    // }}}
    // {{{ getNsRoot
    // ----------------------------------------------------------------------------
    this.getNsRoot = function(nodeKey) {
        // return this.executeLua("return xtypes.nsroot(__rtiLookupTree['" + nodeKey + "'])")[0];
        return callLuaFunction1("lua_getNsRoot", nodeKey);
    }
    // }}}
    // {{{ resolveTypedef
    // ----------------------------------------------------------------------------
    this.resolveTypedef = function(nodeKey) {
        // return this.executeLua("return __rtiLookupTree.addNode(xtypes.resolve(__rtiLookupTree['" + nodeKey + "']))")[0];
        return callLuaFunction1("lua_resolveTypedef", nodeKey);
    }
    // }}}
    ...
    this.getNext = function(nodeKey) {
        ...
        return this.executeLua(" \
                local k,v=next(__rtiLookupTree['" + nodeKey + "']) \
    ...
    this.dumpTree = function(node) {
        ...
        // JS crap here: if you access 'this' in a nested function you will get the global scope.
        // To bind 'this' in a nested function you have to use: _dumpDDSL.call(this, node)
        // Unfortunately you have to do it everywhere you call _dumpDDSL recursively...
        // So it's easier to define a scope local 'me' that is accessible from the inner function
        var me = this;
